...
source: "https://crimethinc.com/2004/11/01/what-is-security-culture"
author:
  - "[[CrimethInc. Ex-Workers Collective]]"
published: 2004-11-01T00:00:00-05:00
created: 2026-06-01T08:48:50-04:00
description: "A security culture is a set of customs shared by a community whose members may be targeted by the government, designed to minimize risk. Having a security culture in place saves everyone the troubl..."
tags:
  - "clippings"
---
...
- **[Security Culture: The Puppet Show](https://crimethinc.com/2009/04/25/security-culture-the-puppet-show)**
- **[Anonymity: Dressing for Success](https://crimethinc.com/2008/10/11/fashion-tips-for-the-brave)**
...
**Key Insight:** A security culture that makes safe behavior *unconscious and habitual* renders infiltrators irrelevant — if compartmentalization is tight enough, an informant in the room has nothing to report. The goal is not vigilance but instinct.

**What Surprised Me:** The article frames security culture as *anti-paranoia* infrastructure. Good practices are supposed to make people feel *more* relaxed, not less — because you already know you're doing everything you can.

**Open Questions:**
- How does this 2004 framework hold up against modern smartphone-era surveillance — location data, device fingerprinting, cloud photo backups, Bluetooth proximity logs?
- What's the inherent tension between strict need-to-know compartmentalization and building a broad, accessible movement that can actually recruit?
- Can the 7-level security rating system be applied outside activist contexts — e.g., labor organizing, whistleblowing, journalism?

**Wikilink Candidates:**
- [[Security Culture]] — creating this page now
- [[Operational Security]] — broader discipline; does not yet exist as a page
- [[Need-to-Know Principle]] — the central rule; does not yet exist

**Connections:**
- No existing wiki pages connect directly — this opens a new domain (activism/security) in the vault
- Thematically adjacent to [[The WIRED Guide to Protecting Yourself From Government Surveillance]] (inbox) and [[Exposing Fascists Best Practices]] (inbox)
